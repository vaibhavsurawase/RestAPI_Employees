...
public class TC001_GET_AllEmployee extends Base
{ 
/*  Validations
...
*/
	@Test
	 void getAllEmpDetails() throws InterruptedException 
	 {
		logger.info("-------------Started TC001_GET_AllEmployee------------------");
		RestAssured.baseURI="https://dummy.restapiexample.com/api/v1";
		hreq = RestAssured.given();
	    response=hreq.request(Method.GET,"/employees");
	    Thread.sleep(7000);
	 }
	 @Test
